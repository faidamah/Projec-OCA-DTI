module.exports = function () {
    ...
    this.Given(/^user click kirimpesan button$/, function () {
        driver.then(function() {
            return driver.wait(until.elementsLocated(by.xpath("/html[1]/body[1]/jdiv[1]/jdiv[1]/jdiv[1]/jdiv[1]/jdiv[2]")), 50000).then(function(){
                return driver.findElements(by.xpath("/html[1]/body[1]/jdiv[1]/jdiv[1]/jdiv[1]/jdiv[1]/jdiv[2]"));
            })
            .then(function(){
                return page.kirimpesanBtn.performClick();
            })
        })
    });
   
    this.When(/^user fill in the message to be sent$/, function () {
        driver.then(function() {
            return driver.wait(until.elementsLocated(by.xpath("/html[1]/body[1]/jdiv[1]/jdiv[1]/jdiv[3]/jdiv[3]/jdiv[1]/jdiv[3]/jdiv[1]/jdiv[1]/textarea[1]")), 50000).then(function(){
                return driver.findElements(by.xpath("/html[1]/body[1]/jdiv[1]/jdiv[1]/jdiv[3]/jdiv[3]/jdiv[1]/jdiv[3]/jdiv[1]/jdiv[1]/textarea[1]"))
            })
            .then(function(){
                return page.fieldTextarea.performFill();
            })
        });
    });
    ...
    this.Then(/^user click send button$/, function () {
        driver.then(function() {
            return driver.wait(until.elementsLocated(by.xpath("/html[1]/body[1]/jdiv[1]/jdiv[1]/jdiv[3]/jdiv[3]/jdiv[1]/jdiv[3]/jdiv[1]/jdiv[2]/jdiv[1]")), 50000).then(function(){
                return driver.findElements(by.xpath("/html[1]/body[1]/jdiv[1]/jdiv[1]/jdiv[3]/jdiv[3]/jdiv[1]/jdiv[3]/jdiv[1]/jdiv[2]/jdiv[1]"));
            })
            .then(function(){
                return page.sendBtn.performClick();
            })
        })
    });
